...
<body class="custom-scrollbar">
   ...
   <div class="container mt-5 mb-1" id="roomsid">
      <div class="row">
         <div class="col-md-4 p-1">
            <!-- Image Placeholder -->
            <img src="img/pardise-rooms.webp" class="img-fluid p-1" alt="Placeholder Image" />
         </div>
         <div class="col-md-4 p-1">
            <img src="img/pardise-rooms.webp" class="img-fluid p-1" alt="Placeholder Image" />
         </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-4 p-1">
            <!-- Image Placeholder -->
            <img src="img/Rooms.webp" class="img-fluid p-1" alt="Placeholder Image" />
         </div>
         <div class="col-md-4 p-1">
            <img src="img/Rooms.webp" class="img-fluid p-1" alt="Placeholder Image" />
         </div>
   ...
   <div class="container mt-5">
      <div class="row">
         <div class="col-md-6 p-0">
            <!-- Left Side Image -->
            <img src="https://via.placeholder.com/700x350" class="img-fluid p-1" alt="Placeholder Image" />
         </div>
         <div class="col-md-6 mt-3">
            ...
            <div class="text-center text-md-start">
               ...
               <p>
                  ...
                  pulvinar risus sit amet justo dapibus, non bibendum nunc commodo.
               </p>
               <p>
                  Mauris dapibus justo sed quam vehicula dignissim. In hac habitasse
                  platea dictumst. Donec non ex et purus tincidunt posuere.
               </p>
            </div>
         </div>
      </div>
